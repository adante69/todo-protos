...
package sherniiazov_sso_v1_ssov1
...
var file_sso_users_proto_rawDesc = []byte{
	...
	0x5a, 0x18, 0x73, 0x68, 0x65, 0x72, 0x6e, 0x69, 0x69, 0x61, 0x7a, 0x6f, 0x76, 0x2e, 0x73, 0x73,
	0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x73, 0x73, 0x6f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_sso_users_proto_goTypes = []any{
...
func file_sso_users_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sso_users_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_sso_users_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_sso_users_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_sso_users_proto_msgTypes[3].Exporter = func(v any, i int) any {
